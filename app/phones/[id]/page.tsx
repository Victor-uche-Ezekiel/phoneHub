...
const phones = [
  {
    ...
    description: 'Experience the ultimate iPhone with the all-new iPhone 15 Pro Max. Featuring a stunning 6.7-inch Super Retina XDR display, powerful A17 Pro chip, and a revolutionary camera system.',
    specs: {
  ...
  },
  {
    ...
    description: 'Introducing the Samsung Galaxy S24 Ultra with AI-powered features, S Pen functionality, and a pro-grade camera system that pushes the boundaries of mobile photography.',
    specs: {
  ...
  },
  {
    ...
    description: 'Meet the Google Pixel 8 Pro, powered by Google Tensor G3 and advanced AI features. Capture stunning photos with the pro-level camera system and experience pure Android at its best.',
    specs: {
  ...
  },
  {
    ...
    description: 'The OnePlus 12 delivers flagship performance with the Snapdragon 8 Gen 3, stunning display, and incredibly fast charging capabilities.',
    specs: {
  ...
  },
  {
    ...
    description: 'The Xiaomi 14 Pro brings premium features to the mid-range segment with its powerful camera system, fast charging, and sleek design.',
    specs: {
...
export default function PhonePage() {
  ...
  const phone = phones.find(p => p.slug === params.id);
    ...
    return (
      <div className="container mx-auto px-4 py-24">
        <div className="text-center">
          ...
          <p className="text-gray-600 mb-8">The phone you're looking for doesn't exist.</p>
          <Link href="/phones">
  ...
  const currentColorImages = selectedColor && phone.colorImages 
  ...
  return (
    <div className="min-h-screen pt-20 pb-12">
      <div className="container mx-auto px-4">
        <Link href="/phones" className="inline-flex items-center gap-2 text-gray-600 hover:text-gray-900 mb-8">
          ...
          <div className="space-y-4">
            ...
            >
              <Image
                ...
                alt={`${phone.name} in ${selectedColor || 'default'} - View ${currentImageIndex + 1}`}
                fill
            ...
            <div className="grid grid-cols-3 gap-4">
              {currentColorImages.map((image, index) => (
                ...
                >
                  <Image
                    src={image}
                    alt={`${phone.name} in ${selectedColor || 'default'} - Thumbnail ${index + 1}`}
                    fill
          ...
          <div className="space-y-6">
            ...
            <div className="flex gap-4 pt-6">
              ...
              >
                ...
                {getItemQuantity(phone.id) > 0 ? 'Add Another' : 'Add to Cart'}
              </Button>
